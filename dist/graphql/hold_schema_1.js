...
var Subscription = (0, _apolloServer.gql)(_templateObject3());
var resolvers = {};

var _default = (0, _apolloServer.makeExecutableSchema)({
  typeDefs: [_user.User, _authentication.Authentication, _eventInterface.EventInterface, _preaching.Preaching, _publicMeeting.PublicMeeting, _event.Event, _notification.Notification, Query, Mutation, Subscription, _product.Product, _room.Room],
  resolvers: (0, _lodash.merge)(resolvers, _user.UserResolvers, _authentication.AuthenticationResolvers, _preaching.PreachingResolvers, _publicMeeting.PublicMeetingResolvers, _event.EventResolvers, _product.ProductResolvers, _room.RoomResolvers),
