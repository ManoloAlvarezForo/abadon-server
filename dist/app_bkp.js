...
promise.then(function (db) {
  server.listen({
    ...
    return console.log('🚀 XOI Server ready at', "http".concat(config.ssl ? 's' : '', "://").concat(config.hostname, ":").concat(config.port).concat(apollo.graphqlPath));
  });
}); // "scripts": {
